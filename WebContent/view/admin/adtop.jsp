			...
			<div id="navbar" class="navbar-collapse collapse" style="display: block!important;">
				...
				<%  String name = (String)session.getAttribute("Adminname"); %>
          		<div class="navbar-right row" id="uloginstate" style="display:block;width: 300px;">
            		<a class="col-md-6" href="login.jsp" target="_top" style="color: #9d9d9d;text-align:right;margin-top:20px">你好：</a>
            		<a class="col-md-6" href="#" style="color: #9d9d9d;margin-top:20px"><%= name %></a>
            	</div>
        	</div>
		</div>
	</nav>
