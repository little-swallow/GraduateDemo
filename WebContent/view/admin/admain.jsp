...
<frameset rows="10%,90%" border="1">
	<frame src="adtop.jsp" name="top" noresize="noresize"/>
		<frameset cols="15%,85%" border="1">
			<frame src="adleft.jsp" name="left" noresize="noresize"/>
		 	<frame src="../../com/demo/controller/SeluserServlet" name="right" noresize="noresize"/>
		</frameset>
</frameset>
</html>